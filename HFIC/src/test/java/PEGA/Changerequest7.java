...
public class Changerequest7 {
	...
	public void uplod_Documents() throws InterruptedException, AWTException {
		...
		driver.findElement(By.id("5933568a")).sendKeys(data.getstringdata("CR", 6, 0));
		driver.findElement(By.id("fd28b87d")).sendKeys(data.getstringdata("CR", 6, 1));
		driver.findElement(By.id("eba1601d")).sendKeys(data.getstringdata("CR", 6, 2));
		driver.findElement(By.id("1bd959e7")).sendKeys(data.getstringdata("CR", 6, 3));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("555e7955")).sendKeys(data.getstringdata("CR", 6, 4));
