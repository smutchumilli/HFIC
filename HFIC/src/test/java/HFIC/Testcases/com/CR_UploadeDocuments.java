...
//		ChangeRequest_Uplodedocuments.Adit_Document_Upload(data.getstringdata("CR", i, 1), data.getstringdata("CR", i, 2), data.getstringdata("CR", i, 3),data.getstringdata("CR", i, 4), i, data.getstringdata("CR", i, 5));
//		}
//	}
	@Test(priority=2)
	public void CR_Other_UploadeDocument() throws InterruptedException, AWTException, IOException {
		...
		ChangeRequest_Uplodedocuments.Other_Document_Upload(data.getstringdata("CR", j, 8), data.getstringdata("CR", j, 9), data.getstringdata("CR", j, 10),data.getstringdata("CR", j, 11), j, data.getstringdata("CR", j, 12));
